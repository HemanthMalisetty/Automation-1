...
public class Base {
	...
	public Properties loadfile() {
		try {
			File f = new File(".\\Configue\\config.properties");
	...
	//Enter data into the pointed element
	public void senddata(String xpath,String data)
	{
		
		WebElement ele=web_element(xpath);
	...
	public void click_dd_by_tag(String xpath,String value,String tag)
	{
        WebElement ele=web_element(prop.getProperty(xpath)+"/ul");
		
        List<WebElement> l1=ele.findElements(By.tagName(tag));
	...
	//this method is used to parse the given string using delimeter and store it in a list
	public List<String> collection_of_data(String data)
	{
