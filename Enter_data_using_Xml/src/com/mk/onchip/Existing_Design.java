...
public class Existing_Design {
	...
	public static void formfill(String stepname) throws Exception {
		...
		Base.senddata(driver, ".//*[@id='ReorderDecoPoNumber']", "po-number");

		/*
		 * Base.clickonelement(driver, ".//*[@id='existingArtwork']/div/div[3]/select");
		 * 
		 * Base.clickondropdownfromprop(driver, "option","selectanid");
		 */
		Base.senddatafromprop(driver, ".//*[@id='ArtworkAutoComplete']", "enteranid");
